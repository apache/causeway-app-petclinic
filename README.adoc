...
|`module-visit`
|Holds the "visit" module, consisting of the `Visit` entity and supporting services.

[TIP]
====
Larger applications should consist of multiple modules, such as the pet owner and visit modules in this application.
====
...
Module-specific tests reside within their module, while application-wide integration tests reside in `webapp-tests`.
